...
-- AddForeignKey
ALTER TABLE "public"."Property" ADD CONSTRAINT "Property_landlordId_fkey" FOREIGN KEY ("landlordId") REFERENCES "public"."Landlord"("supabaseId") ON DELETE RESTRICT ON UPDATE CASCADE;
